...
$language = 'es';
$siteName = 'NeuroVivir';
$siteDomain = $_SERVER['HTTP_HOST'] ?? 'neurovivir.com';
$logoUrl = 'https://' . $siteDomain . '/images/logo.png';
if (is_array($data)) {
...
$labelMap = [
    ...
    'es' => [
        ...
        'subject' => 'Asunto',
        'message' => 'Mensaje',
        'submission' => 'Fecha de envío'
    ]
];
$labels = $labelMap[$language] ?? $labelMap['es'];
...
$submissionLabel = $labels['submission'];
...
$companyTexts = [
    'en' => [
        ...
        'intro' => 'You have received a new message from the NeuroVivir website. Below are the details:'
    ],
    'es' => [
        'title' => 'Nuevo Mensaje de Contacto',
        'intro' => 'Has recibido un nuevo mensaje desde el sitio NeuroVivir. A continuación los detalles:'
    ]
];
...
$optEmailSection = $email !== '' ? <<<EMAIL_HTML
            <div class="section">
                <div class="section-title">{$emailLabel}</div>
                <div class="section-value"><a href="mailto:{$email}">{$email}</a></div>
            </div>
EMAIL_HTML : '';
$optSubjectSection = $subject !== '' ? <<<SUBJECT_HTML
            <div class="section">
                <div class="section-title">{$subjectLabel}</div>
                <div class="section-value">{$subject}</div>
            </div>
SUBJECT_HTML : '';
$optPhoneSection = $phone !== '' ? <<<PHONE_HTML
            <div class="section">
                <div class="section-title">{$phoneLabel}</div>
                <div class="section-value"><a href="tel:{$phone}">{$phone}</a></div>
            </div>
PHONE_HTML : '';
$optMessageSection = $message !== '' ? <<<MSG_HTML
            <div class="section">
                <div class="section-title">{$messageLabel}</div>
...
<head>
    ...
    <style>
        ...
        .header {
            background: linear-gradient(135deg, #008a91 0%, #006c72 100%);
            color: white;
            padding: 40px 20px;
            text-align: center;
        }
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="font-size: 14px; color: #999; margin: 0;">
                <strong>{$submissionLabel}:</strong> {$submissionDate} (UTC)
            </p>
        </div>
...
$subjectCompany = $language === 'es' ? "Nuevo mensaje de contacto - {$siteName}" : "New contact message - {$siteName}";
...
$clientTexts = [
    'en' => [
        ...
        'thankYou' => 'Thank you for contacting NeuroVivir. We are committed to providing helpful mental health care and guidance.',
    ...
    'es' => [
        ...
        'thankYou' => 'Gracias por contactar a NeuroVivir. Estamos comprometidos a brindar apoyo y orientación en salud mental.',
...
CLIENT_EMAIL : '';
$optClientPhoneSection = $phone !== '' ? <<<CLIENT_PHONE
            <div class="info-section">
...
CLIENT_MESSAGE : '';
$optClientSubjectSection = $subject !== '' ? <<<CLIENT_SUBJECT
            <div class="info-section">
                <div class="info-label">{$texts['info_subject']}</div>
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <h3 style="color: #008a91; margin-top: 30px;">{$texts['info_title']}</h3>
            ...
            {$optClientPhoneSection}
            
            {$optClientSubjectSection}
